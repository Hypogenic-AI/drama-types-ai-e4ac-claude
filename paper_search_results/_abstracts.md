### (2023) The Linear Representation Hypothesis and the Geometry of Large Language Models
...
### (2024) Beyond Single Concept Vector: Modeling Concept Subspace in LLMs with Gaussian Distribution
- authors: Haiyan Zhao, Heng Zhao, Bo Shen, Ali Payani, Fan Yang, Mengnan Du
- url: https://www.semanticscholar.org/paper/a865474bcf484c8165dcde2382ab446c1d76eb17
- relevance: 3
...
### (2023) Linear Representations of Sentiment in Large Language Models
- authors: Curt Tigges, O. Hollinsworth, Atticus Geiger, Neel Nanda
- url: https://www.semanticscholar.org/paper/012dda8aef89ffa57128b15dc3cad2c02eedfa80
- relevance: 3
...
- url: https://www.semanticscholar.org/paper/88f9af8b0a28e14c42d4f70ce2d911b51a06cd16
- relevance: 3
...
- url: https://www.semanticscholar.org/paper/b8d21a01963e2a1c49f8eb04581bbfb2919189e9
- relevance: 3
...
### (2026) From Directions to Regions: Decomposing Activations in Language Models via Local Geometry
- authors: Or Shafran, S. Ronen, Omri Fahn, Shauli Ravfogel, Atticus Geiger, Mor Geva
- url: https://www.semanticscholar.org/paper/c14e9e28af1a5916b6ac1712fd2807890de34b05
- relevance: 3
...
### (2025) The Geometry of Harmfulness in LLMs through Subconcept Probing
- authors: Mcnair Shah, Saleena Angeline, Adhitya Rajendra Kumar, Naitik Chheda, Kevin Zhu, Vasu Sharma, Sean O'Brien, Will Cai
- url: https://www.semanticscholar.org/paper/c50b632eb52b2c16e1952903da37febed147f29b
- relevance: 3
...
### (2022) Extracting Latent Steering Vectors from Pretrained Language Models
...
### (2023) Emergent Linear Representations in World Models of Self-Supervised Sequence Models
...
### (2026) Semantic Structure of Feature Space in Large Language Models
- authors: Austin C. Kozlowski, Andrei Boutyline
- url: https://www.semanticscholar.org/paper/3cb38a8fbd701535b0299eb9293d53a974fbcfcd
- relevance: 3
...
### (2026) H-Probes: Extracting Hierarchical Structures From Latent Representations of Language Models
- authors: Cutter Dawes, Aryan Sharma, Angelos Ioannis Lagos, Shivam Raval
- url: https://www.semanticscholar.org/paper/f4da12e8a13ad60c06370c4ded9919aa81b8d688
- relevance: 3
...
### (2024) Sparse Feature Circuits: Discovering and Editing Interpretable Causal Graphs in Language Models
- authors: Samuel Marks, C. Rager, Eric J. Michaud, Yonatan Belinkov, David Bau, Aaron Mueller
- url: https://www.semanticscholar.org/paper/b8f280d8bf685f8da7c83068e73f000528072d6b
- relevance: 1
...
### (2025) Linear Representations of Political Perspective Emerge in Large Language Models
...
### (2025) Emotions Where Art Thou: Understanding and Characterizing the Emotional Latent Space of Large Language Models
- authors: Benjamin Z. Reichman, Adar Avsian, Larry Heck
- url: https://www.semanticscholar.org/paper/8e4293aecc19711a8675ddfdd1d4331cff29fd14
- relevance: 3
...
### (2025) Emergence of Hierarchical Emotion Organization in Large Language Models
- authors: Bo Zhao, Maya Okawa, Eric J. Bigelow, Rose Yu, Tomer D. Ullman, E. Lubana, Hidenori Tanaka
- url: https://api.semanticscholar.org/CorpusId:280253780
- relevance: 1
...
### (2025) Do LLMs "Feel"? Emotion Circuits Discovery and Control
- authors: Chenxi Wang, Yixuan Zhang, Rui Yu, Yufei Zheng, Lang Gao, Zirui Song, Zixiang Xu, Gus G. Xia, Huishuai Zhang, Dongyan Zhao, Xiuying Chen
- url: https://api.semanticscholar.org/CorpusId:282058519
- relevance: 1

As the demand for emotional intelligence in large language models (LLMs) grows, a key challenge lies in understanding the internal mechanisms that give rise to emotional expression and in controlling emotions in generated text. This study addresses three core questions: (1) Do LLMs contain context-agnostic mechanisms shaping emotional expression? (2) What form do these mechanisms take? (3) Can they be harnessed for universal emotion control? We first construct a controlled dataset, SEV (Scenario-Event with Valence), to elicit comparable internal states across emotions. Subsequently, we extract context-agnostic emotion directions that reveal consistent, cross-context encoding of emotion (Q1). We identify neurons and attention heads that locally implement emotional computation through analytical decomposition and causal analysis, and validate their causal roles via ablation and enhancement interventions. Next, we quantify each sublayer's causal influence on the model's final emotion representation and integrate the identified local components into coherent global emotion circuits that drive emotional expression (Q2). Directly modulating these circuits achieves 99.65% emotion-expression accuracy on the test set, surpassing prompting- and steering-based methods (Q3). To our knowledge, this is the first systematic study to uncover and validate emotion circuits in LLMs, offering new 

---

### (2025) Large Language Models for Subjective Language Understanding: A Survey
- authors: Changhao Song, Yazhou Zhang, Hui Gao, Ben Yao, Peng Zhang
- url: https://api.semanticscholar.org/CorpusId:280566427
- relevance: 1
...
### (2025) Beyond Demographics: Fine-tuning Large Language Models to Predict Individuals' Subjective Text Perceptions
- authors: Matthias Orlikowski, Jiaxin Pei, Paul Rottger, Philipp Cimiano, David Jurgens, Dirk Hovy
- url: https://api.semanticscholar.org/CorpusId:276724912
- relevance: 1
...
### (2023) PALS: Personalized Active Learning for Subjective Tasks in NLP
- authors: Kamil Kanclerz, Konrad Karanowski, Julita Bielaniewicz, Marcin Gruza, P. Milkowski, Jan Kocoń, Przemyslaw Kazienko
- url: https://www.semanticscholar.org/paper/c7e2a2cbc6999a2b8dd562733939992f71212d2e
- relevance: 3
...
### (2023) Capturing Human Perspectives in NLP: Questionnaires, Annotations, and Biases
- authors: W. Mieleszczenko-Kowszewicz, Kamil Kanclerz, Julita Bielaniewicz, Marcin Oleksy, Marcin Gruza, Stanisław Woźniak, Ewa Dzieciol, Przemyslaw Kazienko, Jan Kocoń
- url: https://www.semanticscholar.org/paper/1cc976e95489cd3600c0db736edf07cb0343e189
- relevance: 3
...
### (2026) Multi-Perspective LLM Annotations for Valid Analyses in Subjective Tasks
- authors: N. Mehrotra, Adam Visokay, Kristina Gligori'c
- url: https://www.semanticscholar.org/paper/ab51205586bc1242905ce9da460e3c2c53113ccd
- relevance: 1
...
### (2025) Modeling Subjectivity in Cognitive Appraisal with Language Models
- authors: Yuxiang Zhou, Hainiu Xu, Desmond C. Ong, P. Slovák, Yulan He
- url: https://api.semanticscholar.org/CorpusId:277043012
- relevance: 1
...
### (2022) What If Ground Truth Is Subjective? Personalized Deep Neural Hate Speech Detection
- authors: Kamil Kanclerz, Marcin Gruza, Konrad Karanowski, Julita Bielaniewicz, P. Milkowski, Jan Kocoń, Przemyslaw Kazienko
- url: https://www.semanticscholar.org/paper/137880280a103549fdc386adf4168187c41a4dc4
- relevance: 1
...
### (2023) Annotating and Training for Population Subjective Views
- authors: M. Alexeeva, Caroline Hyland, K. Alcock, A. A. B. Cohen, H. Kanyamahanga, Isaac Kobby Anni, M. Surdeanu
- url: https://api.semanticscholar.org/CorpusId:260063070
- relevance: 1
...
- url: https://api.semanticscholar.org/CorpusId:277501934
- relevance: 1
...
### (2023) From Generalized Laughter to Personalized Chuckles: Unleashing the Power of Data Fusion in Subjective Humor Detection
- authors: Julita Bielaniewicz, Przemyslaw Kazienko
- url: https://www.semanticscholar.org/paper/a696ad400a9d74852e43679e08c1429858f6f6da
- relevance: 1
